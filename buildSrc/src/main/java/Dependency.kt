object Versions {
    ...
    const val firebase_messaging_version = "23.1.2"
    ...
    const val byte_buddy_version = "1.14.3"
    const val google_tink_version = "1.8.0"
    const val huawei_agconnect_core_version = "1.8.1.300"
    const val huawei_hms_push_version = "6.9.0.300"
