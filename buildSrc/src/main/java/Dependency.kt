object Versions {
    ...
    const val firebase_messaging_version = "23.4.0"
    ...
    const val support_test_fragment = "1.6.2"
    const val support_annotations = "1.7.1"
    const val buildToolsVersion = "34.0.0"
    const val multiDexVersion = "2.0.0"
    const val kotlinMockito = "4.1.0"
    const val location_services_version = "21.1.0"
    const val espresso_idling_resources = "3.5.1"
    const val archLifecycleVersion = "2.7.0"
    const val java8LifecycleVersion = "2.7.0"
