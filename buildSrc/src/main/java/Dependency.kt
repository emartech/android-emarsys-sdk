object Versions {
    ...
    const val mockito_core_version = "5.0.0"
    const val firebase_messaging_version = "23.1.1"
    const val support_test_version = "1.5.2"
    const val support_rules_test_version = "1.5.0"
    const val support_library = "1.6.0"
    const val support_test_extensions = "1.1.5"
    const val support_test_fragment = "1.5.5"
    ...
    const val byte_buddy_version = "1.12.22"
    const val google_tink_version = "1.7.0"
    const val huawei_agconnect_core_version = "1.8.0.300"
