...
object RequestUrlUtils {
    @JvmStatic
    fun isMobileEngageV3Url(url: String, clientServiceProvider: ServiceEndpointProvider, eventServiceProvider: ServiceEndpointProvider, messageInboxServiceProvider: ServiceEndpointProvider): Boolean {
        return url.startsWith(clientServiceProvider.provideEndpointHost()) || url.startsWith(eventServiceProvider.provideEndpointHost()) || url.startsWith(messageInboxServiceProvider.provideEndpointHost())
    }
